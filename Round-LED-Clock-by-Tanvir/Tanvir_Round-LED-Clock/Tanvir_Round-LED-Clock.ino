...
const char pass[] = "Tweet@555";                        // Your network password here
...
void set_night_brightness() {
  if (currentDateTime.hour == 0 && timeUNIX != 0) {   // It’s 12 AM and valid time received
    FastLED.setBrightness(NIGHTBRIGHTNESS);
  } 
  else if (currentDateTime.hour == 0 && timeUNIX == 0) {    // It’s showing 0 hour but NTP hasn't synced yet
    FastLED.setBrightness(100);  // Use mid brightness
  } 
