...
void convertTime(uint32_t time) {
  ...
  Serial.print(convertDaysToName(currentDateTime.dayofweek+1));  // convertDaysToName() function will convert number to name which takes 1 argument "currentDateTime.dayofweek+1"
...
String convertDaysToName(int daysNumber) {
  switch(daysNumber) {
